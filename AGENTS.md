...
- `SKILL.md` 是控制面，`scripts/jinhua.py` 是唯一 CLI；核心测试看 `scripts/test_core_loop.py`，Codex 触发层看 `hooks/codex-hooks.json`、三个 `hooks/codex_*.py` 和 `scripts/test_trigger_layer.py`。
